...
class EggTimer {
    ...
    goBack() {
        ...
        // Show controls and hide timer display
        this.timerDisplay.classList.add('hidden');
        this.controls.classList.remove('hidden');
        this.resetBtn.classList.add('hidden');
        this.settingsSummary.classList.remove('hidden');
        
        // Remove completion state
        this.timerDisplay.querySelector('.bg-gradient-to-r').classList.remove('timer-complete');
        this.timerDisplay.classList.remove('countdown-active');
        
        // Reset timer display
        this.timeRemainingEl.textContent = '00:00';
        this.cookingModeDisplay.textContent = '';
